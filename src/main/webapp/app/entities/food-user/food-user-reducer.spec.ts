...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './food-user.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOODUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_FOODUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FOODUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FOODUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FOODUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FOODUSER actions', async () => {
      const expectedActions = [
        {
