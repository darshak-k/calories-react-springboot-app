  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="caloriesappApp.userInfo.home.createOrEditLabel" data-cy="UserInfoCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="User Id" id="user-info-userId" name="userId" data-cy="userId" type="text" />
